...
export default function RunConfigPanel() {
  ...
  const inputCls =
    "text-xs rounded px-1.5 py-0.5 focus:outline-none bg-white border border-gray-200 text-gray-700 dark:bg-surface-2 dark:border-surface-border dark:text-gray-300";
